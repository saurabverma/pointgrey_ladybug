...
#if 0
	// @MKD TODO : This is no longer defined by glew 1.9.0 (hoping to get it fixed in 1.9.1).
	//             We don't use it anyway so we comment it out to allow using new glew.
	//             See bug http://sourceforge.net/p/glew/bugs/200/
